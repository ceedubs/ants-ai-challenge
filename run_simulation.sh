...
python tools/playgame.py "scala -cp classes MyBot" "python tools/sample_bots/python/HunterBot.py" "python tools/sample_bots/python/LeftyBot.py" "python tools/sample_bots/python/GreedyBot.py" --player_seed 42 --end_wait=0.25 --verbose -e --log_dir game_logs --turns 300 --map_file tools/maps/maze/maze_04p_01.map
